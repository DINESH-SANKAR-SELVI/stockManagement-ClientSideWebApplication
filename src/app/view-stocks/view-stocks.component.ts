...
@Component({
  ...
  styleUrl: './view-stocks.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ViewStocksComponent implements AfterViewInit {
  ...
  modifyStocks(){
    const dialogRef = this.dialog.open(ModifyStocksComponent);
  ...
  addStocks(){
    ...
    dialogRef.afterClosed().subscribe(result => {
      console.log(`Dialoag result: ${result}`);
    })
  }
